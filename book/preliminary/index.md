...
## Package Management
Since the AI field changes so fast, packages change fast, and their dependencies change fast. As you are experimenting with new (or old) tools, sooner or later, whether during the workshop or afterwards in your research, you will encounter package compatibility issues. Those can be addressed by using virtual environments. You can visit this documentation to learn how to make virtual environments with [mamba](https://mamba.readthedocs.io/en/latest/user_guide/mamba.html). 
