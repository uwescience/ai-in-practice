...
:::{seealso} **Q:** The tutorials do not cover topics that I need to learn for my project idea. Do I have to change the idea in order to attend this workshop?
:class: dropdown
...
:::{seealso} **Q:** I want to build a chatbot! Can you help me?
:class: dropdown
...
:::{seealso} **Q:** I want to find the right AI tool for my work. Do I need to learn programming and machine learning to use AI tools?
:class: dropdown
...
:::{seealso} **Q:** Can I apply to this workshop if I am not affiliated with UW? 
:class: dropdown
